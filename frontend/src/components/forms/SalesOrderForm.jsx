...
import { createSalesOrderSchema } from '../../validators/salesOrder.schema.js';
import { emptyLine, linesTotal, parseFormDate, toDateInput } from '../../utils/formHelpers.js';
import { formatCurrency } from '../../utils/format.js';
import Button from '../common/Button.jsx';

const SalesOrderForm = ({ initialValues, onSubmit, onCancel, contacts = [], products = [], submitLabel = 'Save' }) => {
  ...
  const handleSubmit = useCallback(
    async (e) => {
      ...
      const result = createSalesOrderSchema.safeParse(payload);
      if (!result.success) {
        const fieldErrors = {};
